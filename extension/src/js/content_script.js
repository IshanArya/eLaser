...
point.id = "wow";
point.setAttribute('style', 'width: 10px; height: 10px; background: red; transform: rotate(45deg); backgroundSize: cover; position: fixed; top: 50%; left: 50%; zIndex: 5423543542; display: block');
